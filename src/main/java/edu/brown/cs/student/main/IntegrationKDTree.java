...
public class IntegrationKDTree {
  ...
  public class KdTree<T> {
    ...
    private Node<Coordinate<T>> createNextLayer(int currentDim,
      ...
      if (remainingCoordinates.size() == 0) {
        ...
        Node<Coordinate<T>> medianNode = new Node(medianCoordinate);
        medianNode.addLeft(this.createNextLayer(nextDimension, lesserCoordinates));
        medianNode.addRight(this.createNextLayer(nextDimension, greaterCoordinates));
